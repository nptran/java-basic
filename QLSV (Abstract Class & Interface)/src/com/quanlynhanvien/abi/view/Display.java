package com.quanlynhanvien.abi.view;
...
import com.quanlynhanvien.abi.controller.LecturerController;
import com.quanlynhanvien.abi.controller.StudentController;
...
//dialog
	...
	private static List<Lecturer> lecturers = lcontroller.getAllLecturers();
		
	private static StudentController scontroller = new StudentController();
	private static 	List<Student> students = scontroller.getAllStudents();
